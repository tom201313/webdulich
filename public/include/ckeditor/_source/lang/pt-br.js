...
CKEDITOR.lang['pt-br'] =
{
	...
	templates :
	{
		button			: 'Modelos de pages',
		title			: 'Modelo de pages de conteúdo',
		options : 'Opções de Template',
		insertOption	: 'Substituir o conteúdo atual',
		selectPromptMsg	: 'Selecione um modelo de pages para ser aberto no editor<br>(o conteúdo atual será perdido):',
		emptyListMsg	: '(Não foram definidos modelos de pages)'
	},
