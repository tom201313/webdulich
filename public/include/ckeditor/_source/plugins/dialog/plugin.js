...
(function()
{
		...
		this.on( 'show', function()
			{
				...
				else if ( !this._.hasFocus )
				{
					...
					// Focus the first field in pages order.
					else
						changeFocus( true );
	...
	(function()
	{
		CKEDITOR.ui.dialog =
		{
			...
			/**
			 * Horizontal pages box for dialog UI elements, auto-expends to available width of container.
			 * @constructor
			 ...
			 * 	<li><strong>height</strong> (Optional) The height of the pages.</li>
			 * 	<li><strong>padding</strong> (Optional) The padding width inside child
			 * 	 cells.</li>
			 * 	<li><strong>align</strong> (Optional) The alignment of the whole pages
			 * 	</li>
			 * </ul>
			 * @example
			 */
			...
			/**
			 * Vertical pages box for dialog UI elements.
			 * @constructor
			 ...
			 * The element definition. Accepted fields:
			 * <ul>
			 * 	<li><strong>width</strong> (Optional) The width of the pages.</li>
			 * 	<li><strong>heights</strong> (Optional) The heights of individual cells.
			 * 	</li>
			 * 	<li><strong>align</strong> (Optional) The alignment of the pages.</li>
			 * 	<li><strong>padding</strong> (Optional) The padding width inside child
			 * 	cells.</li>
			 * 	<li><strong>expand</strong> (Optional) Whether the pages should expand
