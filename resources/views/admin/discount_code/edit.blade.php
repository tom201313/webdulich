                        ...
                        <div class="panel-body">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Discount_code Name<span class="required">*</span></label>
                                    <div class="col-sm-6">
                                        <input type="text" name="discount_code_name" value="{{$discount_code ->discount_code_name}}" class="form-control" required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <span class="input-group-addon">
                                            ...
                                            <input type="text" name="start_name" value="{{$discount_code->start_date}}" data-plugin-timepicker class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <span class="input-group-addon">
                                            ...
                                            <input type="text" name="end_data" value="{{$discount_code->end_date}}" data-plugin-timepicker class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <span class="input-group-addon">
                                            ...
                                            <input type="text" name="start_name" value="{{$discount_code->start_date}}" data-plugin-datepicker class="form-control" required/>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <span class="input-group-addon">
                                            ...
                                            <input type="text" name="end_name" value="{{$discount_code->end_date}}" data-plugin-datepicker class="form-control" required/>
                                        </div>
